...
const PageBibliografia = () => {
  return (
    <div className="bg-black text-white min-h-screen px-8 lg:px-16">
      <main className="bg-black rounded-lg p-8 lg:p-12 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="flex-1 text-white mb-6 lg:mb-0 mr-6"> {/* Adicionei margem direita */}
            ...
            <p className="mb-4 text-justify">
              ...
              pode aumentar a percepção positiva dos consumidores sobre o ambiente, influenciar suas emoções e até mesmo suas decisões de compra. Em restaurantes, um aroma agradável pode enriquecer a experiência gastronômica, fazendo com que os clientes se sintam mais confortáveis e propensos a retornar.
            </p>
            <p className="mb-4 text-justify">
          ...
          <div className="lg:w-1/3 mt-6 lg:mt-0"> {/* Margem superior da imagem */}
            <img
              src={mulherImg}
      ...
      <footer className="mt-8 bg-gray-700 text-black rounded-lg p-4 lg:p-6 border-2 border-orange-500 mb-6">
        <h3 className="text-lg lg:text-xl font-bold mb-4 bg-gradient-to-r from-amber-600 to-amber-400 bg-clip-text text-transparent">
